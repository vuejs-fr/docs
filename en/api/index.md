...
<div class="Alert Alert--orange">Vous **n**'avez **PAS** accès à l'instance du composant via `this` au sein de `asyncData` parce que la fonciton est appelée **avant d'initialiser** le composant.</div>
